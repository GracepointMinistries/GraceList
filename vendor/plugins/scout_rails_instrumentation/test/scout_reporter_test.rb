...
class ScoutReporterTest < ActiveSupport::TestCase
  ...
  def test_reporter_calculates_avg_request_time_and_num_requests
    ...
    avg_request_time, num_requests = Scout::Reporter.calculate_avg_request_time_and_num_requests(Scout.reports)
    
    assert_equal 5, avg_request_time
    assert_equal 3, num_requests
  end
